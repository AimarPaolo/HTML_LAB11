            ...
            <table>
                ...
                <?php
                    if(isset($_REQUEST['costo']) && $_REQUEST['costo'] != ""){
                        ...
                        //in questo caso utilizzo questo metodo, si potrebbero utilizzare anche le query parametriche che sono molto più sicure 
                    //ed evitato SQL injection
                        $query = "SELECT * FROM auto_nuove WHERE COSTO <'". $costo ."'";
                    }else{
